...
\definecolor{orange}{HTML}{FFA348}
...
\begin{tikzpicture}[
  ...
  \node (agendapunt) [ORI object, align=center]
   ...
   \node (vergadering) [ORI object, align=center, left=17cm of agendapunt]
        {
          ...
          \attrib{\textbf{Vergaderingstype}}{\enumeratietype{vergaderingstype}}{} \\
   ...
   \node (natuurlijkpersoon) [ORI object, align=center, below=3.3cm of vergadering]
        {
          ...
          \attrib{Aanwezigheid}{aanwezigheidGegevens}{[0..*]}
        };


   \node (fractielidmaatschap) [ORI relatieklasse, below = 5.0cm of natuurlijkpersoon, xshift=6.5cm, align=center]
        {
   ...
   \node (dagelijksbestuurlidmaatschap) [ORI relatieklasse, align=center, below = 5.97cm of fractielidmaatschap]
        {
   ...
   \node (deelnemer) [ORI object, align=center, left=4.0cm of natuurlijkpersoon, yshift=-1.2cm, draw=gray!86]
        {
          \objectheader{Gegevensgroeptype}{Aanwezigheid}
   ...
   \node (naam) [ORI object, below = 2.2cm of deelnemer, xshift=3cm, align=center, draw=gray!86, xshift=-3cm]
        {
   ...
   \node (nevenfunctie) [ORI object, above left = 2.0cm and -9cm of deelnemer, align=center, draw=gray!86]
        {
   ...
   \node (stem) [ORI relatieklasse, align=center, at = ($(natuurlijkpersoon.east)!0.5!(stemming.west)$), yshift=2.8cm]
        {
   ...
   \node (stemresultaatperfractie) [ORI relatieklasse, align=center, below right = 6.7cm and -4.5cm of stem]
        {
  ...
  %% (bestuurslaag);
        ...
        %% natuurlijkpersoon -> vergadering
        \draw[relatiepijl] (natuurlijkpersoon)  --
        node [kardinaliteit, pos=0.0, yshift=\kyshiftbeg, right] {\oldstylenums{0..*}}
        node [kardinaliteit, pos=1.0, yshift=-\kyshiftend, right] {\oldstylenums{1}}
        node [anchor=center, fill=white] {neemt deel aan\\\umltype{Relatiesoort}} (vergadering);
        %% natuurlijkpersoon -> deelnemer
        \draw[gegevenspijl] (natuurlijkpersoon) --  ($(deelnemer.east |- natuurlijkpersoon)$);;
        %% \draw[relatiepijl] (natuurlijkpersoon) --
        ...
        %% (natuurlijkpersoon);
        %% natuurlijkpersoon -> stemming
        \draw[dashedpijl] ($(natuurlijkpersoon.east)!0.5!(stemming.west) + (0, -.19)$) -- (stem);
        \coordinate (natuurlijkpersoonshifted) at ($(natuurlijkpersoon.east) - (0,0.5cm)$);
        \coordinate (stemmingshifted) at ($(stemming.west) - (0,0.5cm)$);
        % Use the `|-` operator to align vertically while shifting horizontally
        \draw[relatiepijl] 
        ($(natuurlijkpersoonshifted |- stemmingshifted)$) --
        node [kardinaliteit, pos=0.0, xshift=\kxshiftbeg, above] {\oldstylenums{0..*}}
        ...
        %% natuurlijkpersoon -> agendapunt (by way of spreekfragment)
        \draw[relatiepijl] ($(natuurlijkpersoon.north) + (3cm, 0)$) --
        node [kardinaliteit, pos=0.0, yshift=\kyshiftbeg, right] {\oldstylenums{0..*}}
        ($(natuurlijkpersoon.north) + (3cm, 2.6cm)$) --
        ...
        ($(natuurlijkpersoon.north) + (12cm, 2.6cm)$) |-
        node [kardinaliteit, pos=1.0, xshift=-\kxshiftend, above] {\oldstylenums{0..*}}
        ...
        ($(bumpstart) - (0,3.0cm)$) -|
        node [pos=0.22, above] {heeft behandelend ambtenaar}
        node [pos=0.22, below] {\umltype{Relatiesoort}}
        node [kardinaliteit, pos=1, right, yshift=-\kyshiftbeg, xshift=\kxshiftbeg] {\oldstylenums{0..1}}
        ($(natuurlijkpersoon.south) + (3.2cm, 0)$);
        ...
        node [kardinaliteit, right, pos=1, yshift=\kyshiftend] {\oldstylenums{1}}
        ...
        %% persoon -> naam
        \draw[gegevenspijl] ([xshift=-4cm] natuurlijkpersoon.south) |- (naam.east) ;
        %% persoon -> nevenfunctie
        \draw[gegevenspijl] ([xshift=-4cm] natuurlijkpersoon.north) |- ([yshift=-1cm] nevenfunctie.east);
        ...
        \draw[relatiepijl] (natuurlijkpersoon) ($(natuurlijkpersoon.south)+(0.5,0)$)  |-
        node[kardinaliteit, pos=0, right, yshift=-\kyshiftbeg] {\oldstylenums{0..*}}
        ...
        \draw[relatiepijl] (natuurlijkpersoon) ($(natuurlijkpersoon.south)-(2.0,0)$) |-
        ...
        node [kardinaliteit, pos=0, above, xshift=-\kxshiftbeg] {\oldstylenums{1..*}}
        node [kardinaliteit, pos=1, right, yshift=\kyshiftend] {\oldstylenums{0..1}}
