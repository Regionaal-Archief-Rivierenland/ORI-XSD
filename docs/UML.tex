...
\begin{tikzpicture}[
  ...
  \node (agendapunt) [ORI object, align=center]
   ...
   \node (deelnemer) [ORI object, align=center, below=3.9cm of vergadering]
    ...
    \node (fractie) [ORI object, below = 5.5cm of stemming, align=center]
        {
   ...
   \node (stemresultaatperfractie) [ORI relatieklasse, align=center, below right = 5cm and -4.5cm of stem]
        {
   ...
   \node (dagelijksbestuur) [ORI object, align=center, below = 6.9cm of fractie]
        {
  ...
  \node (mdto) [fit=(mdto-inner), draw, ultra thick, inner sep=1.1cm] {};
       ...
       %% deelnemer -> vergadering
        ...
        ($(fractielidmaatschap.south)-(0.0cm,2.5cm)$) -| (fractie.south);
        %% dashed line
        ...
        node [above, fill=white, pos=1.15] {is lid van}
        node [below, pos=1.15] {\umltype{Relatiesoort}}
        ...
        \node[draw=mainblack, rounded corners=5pt, very thick, inner sep=16pt,
          ...
          below right=-4.5cm and 3.1cm of fractie, align=left]
        (enumeraties) {
