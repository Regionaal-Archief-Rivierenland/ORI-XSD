...
%% \usepackage[kerning=true, tracking=true]{microtype} %% tracking is pdftex only
...
\begin{tikzpicture}[
  ...
  %% arrows
        ...
        \newcommand{\enumeration}[2]{
          \umltype{Enumeratie} \; \textcolor{mainblack}{{\sourcesansprolight\bfseries#1}}\\[0.9ex]
        ...
        \node[draw=mainblack, rounded corners=5pt, very thick, inner sep=16pt,
          label={[anchor=south west]north west:{\large \textcolor{mainblack}{\sourcesansproextreme\bfseries Enumeraties}}},
