...
\begin{tikzpicture}[
  ...
  \node (mdto-inner) [rectangle, draw, ultra thick, above right = 4cm and -0.8cm of stemmingOverPersonenGegevens, inner sep=40pt, fill=githubgrey, align=center]
        {
          {\huge MDTO}
        };

  % Outer MDTO rectangle (this is what arrows should connect to)
  \node (mdto) [fit=(mdto-inner), draw, ultra thick, inner sep=1.0cm] {};
    
        
  \node (informatieobject) [ORI object, left = 3cm of mdto, align=center]
        {
          \objectheader{Gegevensgroeptype}{Informatieobject}
