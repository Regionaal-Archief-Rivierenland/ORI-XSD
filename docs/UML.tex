...
\begin{tikzpicture}[
  ...
  \node (stemming) [ORI object, below = 2cm of agendapunt, align=center]
        {
  ...
  \node (besluit) [ORI object, above = 2cm of stemming, right = 2cm of agendapunt, align=center]
        {
          \objectheader{Objecttype}{Besluit}

          \attribute{ID}{string}{} \\
          \attribute{Besluittoelichting}{string}{} \\
          \attribute{Toezegging}{string}{} \\
          \attribute{Besluit resultaat}{string}{} \\
        };
