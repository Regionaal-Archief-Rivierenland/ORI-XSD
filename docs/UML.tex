...
\begin{tikzpicture}[
  ...
  \node (agendapunt) [ORI object, align=center]
   ...
   \node (dagelijksbestuurlidmaatschaap) [ORI relatieklasse, align=center, below = 7.5cm of stemresultaatperfractie]
        {
   ...
   \node (dagelijksbestuur) [ORI object, align=center, below = 7.5cm of fractie]
        {
          ...
          \attribute{\textbf{ID}}{string}{} \\
          \attribute{Dagelijks bestuur naam}{string}{[0..1]} \\ 
          \attribute{Dagelijks bestuur type}{\keuze{College} | \keuze{Gedeputeerde Staten}}{[0..1]} \\
