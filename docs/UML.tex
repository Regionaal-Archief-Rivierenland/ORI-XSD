...
\begin{tikzpicture}[
    ...
    ORI relatieklasse/.style={rectangle split, rectangle split parts=2,
      ...
      very thick, inner sep=10pt, draw=gray!87, fill=white,
      },
    ...
    dashedpijl/.style={very thick, dashed, text=mainblack, draw=gray!87},
  ...
  \node (agendapunt) [ORI object, align=center]
   ...
   \node (naam) [ORI object, below = 2.2cm of natuurlijkpersoon, align=center, draw=gray, xshift=-3cm]
        {
   ...
   \node (nevenfunctie) [ORI object, above left = 2.2cm and -9cm of natuurlijkpersoon, align=center, draw=gray]
        {
          ...
          \attribute{Indicator nevenfunctie vanwege lidmaatschap}{boolean}{[0..1]} \\
  ...
  %% arrows
        ...
        node [kardinaliteit, pos=0.965, above] {1};
        ...
        \node[draw=mainblack, rounded corners=5pt, very thick, inner sep=16pt,
          label={[anchor=south west]north west:{\large \textcolor{mainblack}{\textbf{Enumeraties}}}},
